...
const AboutHeader = () => (
  <div className="c-about-header">
    {/* <img src={TealTeaAngleBrush} alt="Teal Tea Angle Brush" className="c-about-header__teabrush" />
    <img src={AfterHoursSquare} alt="After Hours Square Grid" className="c-about-header__squaregrid" />
    <img src={VioletBirds} alt="Violet Birds Flock" className="c-about-header__birds" /> */}
