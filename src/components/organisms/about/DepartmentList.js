...
const DepartmentList = () => (
  <div className="c-about-department-list">
    ...
    <div className="c-about-department-list__item">
      <img src       = {GeometricBlock}
           className = "c-about-department-list__geometric-block" />
      <DepartmentBlock 
          name    = {"Strategy"}
    ...
    <div className="c-about-department-list__item">
      <img src       = {AndFreshCircle}
           className = "c-about-department-list__fresh-circle" />
      <img src       = {VioletStrokedSquare}
           className = "c-about-department-list__violet-square" />
      <DepartmentBlock 
          name    = {"Engineering"}
      ...
      <img src       = {CenterLaneScribbles}
           className = "c-about-department-list__scribbles" />
      <img src       = {StickyNoteBrushSquares}
           className = "c-about-department-list__brush-squares" />
    </div>
    <div className="c-about-department-list__item">
      <DepartmentBlock
          name    = {"Engagement"}
