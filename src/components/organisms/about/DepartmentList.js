    ...
    <div>
      ...
      <div className="c-about-department-list__item">
        <DepartmentBlock
            ...
            isShort = { true }>
          <img src = {GeometricBlock} className = "c-about-department-list__image -geometric-block" alt="" />
          <img src = {BlueSwoosh} className = "c-about-department-list__image -swoosh" alt="" />
          <img src = {X} className = "c-about-department-list__image -x" alt="" />
          <img src = {SixDots} className = "c-about-department-list__image -six-dots" alt="" />
          <img src = {FogDot} className = "c-about-department-list__image -fog-dot" alt="" />
        </DepartmentBlock>
      </div>
      <div className="c-about-department-list__item">
        <DepartmentBlock
            ...
            alignRight = { true }>
          <img src = {Go} className = "c-about-department-list__image -go" alt="" />
          <img src = {Squiggle} className = "c-about-department-list__image -squiggle" alt="" />
          <img src = {AlignLines} className = "c-about-department-list__image -align-lines" alt="" />
          <img src = {DoodleDots} className = "c-about-department-list__image -doodle-dots" alt="" />
        </DepartmentBlock>
      </div>
      <div className="c-about-department-list__item">
        <DepartmentBlock
          ...
          <img src = {StickyNoteBrushSquares} className = "c-about-department-list__image -brush-squares" alt="" />
          <img src = {DabDots} className = "c-about-department-list__image -dab-dots" alt="" />
          <img src = {Asterisk} className = "c-about-department-list__image -asterisk" alt="" />
          <img src = {RedBlob} className = "c-about-department-list__image -red-blob" alt="" />
          <img src = {BendyLines} className = "c-about-department-list__image -bendy-lines" alt="" />
        </DepartmentBlock>
      </div>
      <div className="c-about-department-list__item">
        <DepartmentBlock
            ...
            isWide  = { true }>
          <img src = {Plant} className = "c-about-department-list__image -plant" alt="" />
          <img src = {Triangle} className = "c-about-department-list__image -triangle" alt="" />
          <img src = {Rainbow} className = "c-about-department-list__image -rainbow" alt="" />
        </DepartmentBlock>
      </div>
    </div>
  </div>
